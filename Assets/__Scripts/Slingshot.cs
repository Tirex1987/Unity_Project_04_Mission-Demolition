...
{
    static private Slingshot S; //Скрытый объект-одиночка
    ...
    public bool aimingMode; //Устанавливаем в true, когда игрок нажимает кнопку мыши с номером 0
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonUp(0))
        {
            ...
            FollowCam.POI = projectile; //Запускаем слежение камеры за снарядом
            projectile = null;
