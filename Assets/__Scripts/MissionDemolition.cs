...
public class MissionDemolition : MonoBehaviour
{
    ...
    public TMPro.TextMeshProUGUI uitLevel;  //Ссылка на объект UIText_Level
    public TMPro.TextMeshProUGUI uitShots;  //Ссылка на объект UIText_Shots
    public TMPro.TextMeshProUGUI uitButton;  //Ссылка на дочерний объект Text в UIButton_View
